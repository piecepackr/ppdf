...
for (g in c(
	unicode_chess_black,
	unicode_chess_black90,
	unicode_chess_black180,
	unicode_chess_black270
)) {
	suit_list[[g]] <- 2L
}
for (g in c(
	unicode_chess_white,
	unicode_chess_white90,
	unicode_chess_white180,
	unicode_chess_white270
)) {
	suit_list[[g]] <- 6L
}
# For now let "neutral" chess pieces be the "red" suit
for (g in c(
	unicode_chess_neutral,
	unicode_chess_neutral90,
	unicode_chess_neutral180,
	unicode_chess_neutral270
)) {
	suit_list[[g]] <- 1L
}
...
for (i in seq.int(22L)) {
	# 22 tarot trump cards
