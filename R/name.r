...
normalize_system <- function(system) {
	...
	switch(
		...
		tarot = "tarot",
		{
			rlang::inform(
				c(
					paste("Don't recognize game system", sQuote(system), "yet."),
...
#' @export
alquerque_setup_by_name <- function(
	name,
	...,
	getter = function(x) get(x, envir = getNamespace("ppdf"))
) {
...
#' @rdname setup_by_name
#' @export
checker_setup_by_name <- function(
	name,
	...,
	getter = function(x) get(x, envir = getNamespace("ppdf"))
) {
...
#' @rdname setup_by_name
#' @export
go_setup_by_name <- function(name, ..., getter = function(x) get(x, envir = getNamespace("ppdf"))) {
	setup_by_name(name, "go", ..., getter = getter)
}

#' @rdname setup_by_name
#' @export
marble_setup_by_name <- function(
	name,
	...,
	getter = function(x) get(x, envir = getNamespace("ppdf"))
) {
...
#' @rdname setup_by_name
#' @export
piecepack_setup_by_name <- function(
	name,
	...,
	getter = function(x) get(x, envir = getNamespace("ppdf"))
) {
...
#' @rdname setup_by_name
#' @export
reversi_setup_by_name <- function(
	name,
	...,
	getter = function(x) get(x, envir = getNamespace("ppdf"))
) {
...
#' @rdname setup_by_name
#' @export
stackpack_setup_by_name <- function(
	name,
	...,
	getter = function(x) get(x, envir = getNamespace("ppdf"))
) {
