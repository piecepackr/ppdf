...
#' @export
checkers_by_name <- function(name, ..., getter = function(x) get(x, envir = getNamespace("ppdf"))) {
...
#' @rdname ppdf-deprecated
#' @export
chess_by_name <- function(name, ..., getter = function(x) get(x, envir = getNamespace("ppdf"))) {
...
#' @rdname ppdf-deprecated
#' @export
dominoes_by_name <- function(name, ..., getter = function(x) get(x, envir = getNamespace("ppdf"))) {
...
#' @export
piecepack_rect_board_tiles <- function(
	nrows = 8L,
	ncols = 8L,
	x0 = 1,
	y0 = 1,
