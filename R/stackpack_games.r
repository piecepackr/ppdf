...
#'
#' \code{tibble} data frames of setups for `r nrow(games_stackpack_other())` other games playable with a piecepack stackpack.
...
#'
#' `r man_markdown_table(games_stackpack_other())`
#'
