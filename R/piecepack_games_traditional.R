...
piecepack_brandubh <- function() {
	...
	df_c <- tibble(
		piece_side = c(rep("coin_back", 4L), "die_face"),
		suit = 3L,
	...
	df_a <- tibble(
		piece_side = c(rep("coin_back", 4L), "pawn_face"),
		suit = 4L,
...
piecepack_nine_mens_morris <- function(has_matchsticks = FALSE) {
	df <- piecepack_tiles(
		x = c(7, 1, 7, 3, 7, 5, 13, 13, 11, 11, 9, 9, 7, 13, 7, 11, 7, 9, 1, 1, 3, 3, 5, 5),
		y = c(13, 13, 11, 11, 9, 9, 7, 13, 7, 11, 7, 9, 1, 1, 3, 3, 5, 5, 7, 1, 7, 3, 7, 5)
	)
	if (has_matchsticks) {
		df_m <- piecepack_matchsticks(
			suit = rep(1:4, each = 6L),
			rank = 4L,
			x = c(1, 1, 3, 3, 5, 5, 9, 9, 11, 11, 13, 13, 9, 9, 11, 11, 13, 13, 1, 1, 3, 3, 5, 5),
			y = c(9, 11, 9, 13, 13, 11, 11, 13, 13, 9, 11, 9, 3, 1, 1, 5, 5, 3, 3, 5, 5, 1, 1, 3),
...
piecepack_salta <- function(has_subpack = FALSE) {
	...
	if (has_subpack) {
		df_st <- piecepack_tiles(
			...
			y = rep(c(2, 3, 8, 9), each = 5),
			angle = rep(c(0, 180), each = 10)
		)
		df_tb <- piecepack_tiles(
			side = "back",
			cfg = "subpack",
