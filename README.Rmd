...
`{ppdf}` supports the following `r nrow(ppdf::checkers_games())` games playable with a (possibly non-8x8) checkers set:

`r ppdf:::readme_markdown_list(ppdf::checkers_games())`
