...
---
    ...
    Code
      cat_piece(piecepack_lab_rats(seed = 42))
...
---
    ...
    Code
      cat_piece(piecepack_shopping_mall(seed = 42))
    Warning <simpleWarning>
...
---
    ...
    Code
      cat_piece(piecepack_steppin_stones(seed = 42))
    Warning <simpleWarning>
      Can't rotate ☾ 90 degrees
      Can't rotate a 90 degrees
      Can't rotate ⸸ 270 degrees
...
---
    ...
    Code
      cat_piece(piecepack_chaturaji(TRUE), reorient = "all")
    Output
       ┌─┬─┬─┰─┬─┬─┬─┬─┐
       │2│☀⃝│ ┃ │5│3│a│2│
       ├─┾━┿━╋━┽─╁─┼─╁─┤
...
---
    ...
    Code
      cat_piece(piecepack_four_seasons_chess(TRUE), reorient = "all")
    Output
       ┌─┬─┬─┰─┬─┰─┬─┬─┐
       │5│3│☀⃝┃ │ ┃⸸⃝│3│5│
       ├─┼─┾━╋━┿━╋━┽─┼─┤
...
---
    ...
    Code
      cat_piece(piecepack_international_chess(TRUE))
    Output
       ┌─┬─┬─┬─┬─┬─┬─┬─┐
       │↋│ɐ│↊│ᔭ│ↅ̲│↊│ɐ│↋│
       ├─╁─┼─╁─┼─╁─┼─╁─┤
...
---
    ...
    Code
      cat_piece(piecepack_salta(TRUE))
    Output
       ┌─┰─┬─┰─┬─┰─┬─┰─┬─┰─┐
       │ ┃ↅ̲⃝│ ┃ᔭ⃝│ ┃↋⃝│ ┃↊⃝│ ┃ɐ⃝│
       ├─╄━┽─╄━┽─╄━┽─╄━┽─╄━┥
...
---
    ...
    Code
      cat_piece(piecepack_shogi(TRUE), reorient = "all")
    Output
       ┌─┬─┬─┐     ┌─┬─┬─┐
       │4│a│5├5⃞─♛⃟─5⃞┤5│a│4│
       └┬┼─┼┬┘┃ │ ┃└┬┼─┼┬┘
...
---
    ...
    Code
      cat_piece(piecepack_ultima(TRUE))
    Output
       ┌─┬─┬─┬─┬─┬─┬─┬─┐
       │↋│ɐ│↊│ᔭ│ↅ̲│↊│ɐ│3⃞│
       ├─╁─┼─╁─┼─╁─┼─╆━┥
...
---
    ...
    Code
      cat_piece(piecepack_xiangqi(TRUE))
    Output
       ┌─┬─┬─┬─┬─┬─┬─┬─┬─┐
       │↋│ɐ│↊│ᔭ│ↅ̲│ᔭ│↊│ɐ│↋│
       └┬┴┰┴┬┴┬┴─┴┬┴┬┴┰┴┬┘
